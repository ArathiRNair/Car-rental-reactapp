                    ...
                    <div className="col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                        ...
                        <div className="row g-4">
                            ...
                            <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                ...
                                <input type="text" className="form-control" name="model"value={input.value}onChange={inputHandeler}/>
                            ...
                            <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                ...
                                <input type="text" className="form-control"name="seating_capacity"value={input.seating_capacity}onChange={inputHandeler} />

                            </div>
                            <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">

                                <label htmlFor="" className="form-label">rent_per_day</label>
                                <input type="text" className="form-control" name="rent_per_day"value={input.rent_per_day}onChange={inputHandeler}/>
